...
document.getElementById('ninsForms').innerHTML = `[<a target="_blank" rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLScFvHqSal-_GkrtrUIG7v3dXmk0aubYma2DCnl-aXBPjWW-ng/viewform">Co-founders</a>]`;
document.getElementById('ninsForms').innerHTML = `[<a target="_blank" rel="noopener noreferrer" href="https://sites.google.com/view/duguaynins/">Co-founders</a>]`;

document.addEventListener('click', function (e) {
    if (e.target.tagName === 'BUTTON') {
        if (window.location.protocol === "https:") {
            console.log("HTTPS:"); document.getElementById('merryXmas').innerHTML = "☃️🦌🎄✨⭐<br>[ © nins ] x [ HTTPS ]";  /// + SSL
        } else if (window.location.protocol === "http:") {
            console.log("HTTP:"); document.getElementById('merryXmas').innerHTML = "☃️🦌🎄✨⭐<br>[ © nins ] x [ HTTP ]";
        }
    }
}, { once: true });
